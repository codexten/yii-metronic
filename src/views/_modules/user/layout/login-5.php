...
<div class="m-login m-login--signin  m-login--5" id="m_login"
     style="background-image: url(/media/metronic/img/bg/bg-3.jpg);">
            ...
            <div class="m-login__contanier">
                <div class="m-login__content">
                    <div class="m-login__logo">
                        <a href="#">
                            <img src="/media/metronic/img/logos/logo-2.png">
                        </a>
                    </div>
                    ...
                    <div class="m-login__form-action">
                        <button type="button" id="m_login_signup" class="btn btn-outline-focus m-btn--pill">Get An
                            Account
                        </button>
                    </div>
                </div>
                ...
                <form class="m-login__form m-form" action="">
                    ...
                    <div class="m-login__form-action">
                        <button id="m_login_forget_password_submit"
                                class="btn btn-focus m-btn m-btn--pill m-btn--custom m-btn--air">Request
                        </button>
